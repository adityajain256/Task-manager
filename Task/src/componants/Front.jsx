...
//               </select>
//               <button
//                 className="bg-red-500 p-2 rounded-2xl text-xl px-3"
//                 id="add"
//                 onClick={handleAdd}
//               >
//                 Add
...
//                 key={task.id}
//                 style={{
//                   background: task.checked ? "#7CFC00" : "transparent", // leaf green
//                   transition: "background 0.3s",
//                   color: task.checked ? "black" : "white",
//                 }}
//               >
//                 <td className="w-fit px-5">{task.text}</td>
...
//                       alt="status"
//                       className="bg-white px-2 py-1 rounded-xl mx-1"
//                     />
//                   </button>
//                   <button
//                     id="delete"
